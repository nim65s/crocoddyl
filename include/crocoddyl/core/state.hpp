...
using MatrixType =
    typename std::conditional<Type, Eigen::Matrix<Scalar, Rows, Cols>, Eigen::SparseMatrix<Scalar>>::type;
...
class StateAbstract {
 public:
  ...
  virtual VectorType<Type, Scalar, NDX> diff(const VectorType<Type, Scalar, NX> &x0,
                                             const VectorType<Type, Scalar, NX> &x1) = 0;

  virtual VectorType<Type, Scalar, NX> integrate(const VectorType<Type, Scalar, NX> &x0,
                                                 const VectorType<Type, Scalar, NDX> &dx) = 0;

  virtual MatrixType<Type, Scalar, NDX, NDX> Jdiff(const VectorType<Type, Scalar, NX> &x0,
                                                   const VectorType<Type, Scalar, NX> &x1,
                                                   std::string firstsecond = "both") = 0;

  virtual MatrixType<Type, Scalar, NDX, NDX> Jintegrate(const VectorType<Type, Scalar, NX> &x,
  ...
  void printer(const VectorType<Type, Scalar, NX> &x0, const VectorType<Type, Scalar, NX> &x1,
               const VectorType<Type, Scalar, NDX> &dx);
